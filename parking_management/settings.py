...
SECRET_KEY = 'django-insecure-zy&b*080o-@hm6q7%19k%is1!ym2r4@vctvwc2qqi^!ohb)cvw'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'parking_db'),
        'USER': os.getenv('MYSQL_USER', 'parking_user'),
...
# Cấu hình thư mục static files
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Cấu hình cho crispy_forms
